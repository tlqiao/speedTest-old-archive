...
WRITE_WEB_LOCATOR = """
Write reasonable locator with {test_tool} for every element in the page base on web page body, follow LOCATOR TEMPLATE format, generate code directly, do not write explanatory information.
...
"""
template = "You are an ui auto test expert,write test step function with {test_tool} base on page locators and test step description. Generate code directly, do not write explanatory information"
system_message_prompt = SystemMessagePromptTemplate.from_template(template)
